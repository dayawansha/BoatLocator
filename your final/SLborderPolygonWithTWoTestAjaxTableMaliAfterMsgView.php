...
<script>
    ...
    var markersAry = [];
    var tableNamesResponse2 = [];



    /*===================================================function for notification==============================*/

    function notificatioFunction( boatLatLongASInput ,google_path , map , tableNamesResponse2 ) {
     ...
     //   var markersAry = [];
      ...
      //  y = google.maps.geometry.poly.containsLocation(boatLatLongASInput, SLLatLonForFunction);
        ...
        if (google.maps.geometry.poly.containsLocation(boatLatLongASInput, SLLatLonForFunction) == true) {
            ...
            if (google.maps.geometry.poly.containsLocation(boatLatLongASInput, LatLonForFunctionYuCreated) == true) {
              ...
              //  alert("you have : " + All_Distencec.min() + " 'meeters' distance with Srilanken Fishing Border");
                ...
                var contentString = '<div id="content" style="background: #FFFF99; " >' +
                    '<div id="siteNotice" >' +
                    '</div>' +
                    '<h4 id="firstHeading" class="firstHeading"> '  + tableNamesResponse2 + ' boat is Going to cross the Border"</h4>' +
                    '<div id="bodyContent">' +
                    "This boat have:<b> " + parseInt(All_Distencec.min()) + "</b> m...!!<b> (" + (parseInt(All_Distencec.min()))/1000 + "</b> Km.) <br> distance with Srilanken Fishing Border." +


                    '<p>About the Boat, <a href="maliPhp.php">' + /*==========link the malinda's path php file==============*/
                    'click here</a> ' +
                    '</div>' +
                    '</div>';
           ...
           // alert("in function "+tableNamesResponse2);

            var contentString = '<div id="content" style="background: #FF7373; " >' +
                '<div id="siteNotice" >' +
                '</div>' +
                '<h4 id="firstHeading" class="firstHeading"> '  + tableNamesResponse2 + ' boat has crossed the Border"</h4>' +
                '<div id="bodyContent">' +
                "you have pass the Srilanken border<b> " + parseInt(All_Distencec.min()) + "</b> m...!!<b> (" + (parseInt(All_Distencec.min()))/1000 + "</b> Km.) <br> Please go to the Srilanken Fishing area." +

                '<p>About the Boat, <a id="msgBox" href="maliPhp.php">' +  /*==========link the malinda's path php file==============*/
                'click here</a> ' +
                '</div>' +
                '</div>';
...
/*
            <?php
            //    $_SESSION['response'] = tableNamesResponse2 ;
           ...
           // }
/*<div id=tableName > '  + tableNamesResponse2 + '</div>
            var name = escape(document.getElementById("tableName").value);
            alert(name);
 ...
 //  });
    ...
    function initMap() {
        var map = new google.maps.Map(document.getElementById('map'), {
            center: {lat: 7.000151, lng: 80.355835},
            zoom: 6,
        ...
        // most hard array I have crated..........
        var slLandBorder = [
            {lng: 80.242064, lat:9.82819 },
            {lng: 80.25221, lat:9.824999 },
            {lng: 80.252685, lat:9.824078 },
            {lng: 80.256936, lat:9.815836 },
            {lng: 80.259718, lat:9.801664 },
            {lng: 80.259856, lat:9.801342 },
            {lng: 80.263882, lat:9.791945 },
            {lng: 80.2747, lat:9.774999 },
            {lng: 80.342982, lat:9.686245 },
            {lng: 80.346684, lat:9.682333 },
            {lng: 80.356154, lat:9.672327 },
            {lng: 80.39049, lat:9.636825 },
            {lng: 80.401928, lat:9.624999 },
            {lng: 80.462427, lat:9.578506 },
            {lng: 80.574709, lat:9.492218 },
            {lng: 80.585864, lat:9.484568 },
            {lng: 80.589291, lat:9.482218 },
            {lng: 80.609982, lat:9.471663 },
            {lng: 80.6272, lat:9.460827 },
            {lng: 80.631375, lat:9.457954 },
            {lng: 80.639709, lat:9.452218 },
            {lng: 80.647542, lat:9.445992 },
            {lng: 80.666791, lat:9.43069 },
            {lng: 80.699971, lat:9.397886 },
            {lng: 80.715818, lat:9.382218 },
            {lng: 80.745201, lat:9.352516 },
            {lng: 80.765828, lat:9.331663 },
            {lng: 80.800264, lat:9.294581 },
            {lng: 80.808003, lat:9.284132 },
            {lng: 80.824436, lat:9.261945 },
            {lng: 80.844709, lat:9.226945 },
            {lng: 80.847624, lat:9.221451 },
            {lng: 80.847625, lat:9.221452 },
            {lng: 80.849428, lat:9.218054 },
            {lng: 80.93221, lat:9.040836 },
            {lng: 80.930264, lat:8.979445 },
            {lng: 80.923591, lat:8.975972 },
            {lng: 80.912764, lat:8.950827 },
            {lng: 80.917764, lat:8.939309 },
            {lng: 80.927346, lat:8.931527 },
            {lng: 80.937764, lat:8.931245 },
            {lng: 80.961519, lat:8.942218 },
            {lng: 80.9686, lat:8.952218 },
            {lng: 81.02721, lat:8.916663 },
            {lng: 81.166091, lat:8.744999 },
            {lng: 81.222764, lat:8.663609 },
            {lng: 81.232073, lat:8.648609 },
            {lng: 81.2536, lat:8.550827 },
            {lng: 81.25041, lat:8.540554 },
            {lng: 81.240537, lat:8.536663 },
            {lng: 81.22901, lat:8.538609 },
            {lng: 81.224982, lat:8.56569 },
            {lng: 81.21111, lat:8.57139 },
            {lng: 81.147764, lat:8.527218 },
            {lng: 81.130255, lat:8.502363 },
            {lng: 81.139291, lat:8.491527 },
            {lng: 81.21971, lat:8.462772 },
            {lng: 81.254437, lat:8.454999 },
            {lng: 81.268328, lat:8.454163 },
            {lng: 81.281519, lat:8.461663 },
            {lng: 81.292346, lat:8.478745 },
            {lng: 81.290955, lat:8.495063 },
            {lng: 81.32721, lat:8.520136 },
            {lng: 81.358319, lat:8.491109 },
            {lng: 81.36331, lat:8.482218 },
            {lng: 81.388319, lat:8.384445 },
            {lng: 81.390828, lat:8.373327 },
            {lng: 81.423037, lat:8.201945 },
            {lng: 81.397619, lat:8.185763 },
            {lng: 81.391937, lat:8.149445 },
            {lng: 81.423037, lat:8.092636 },
            {lng: 81.519437, lat:8.000272 },
            {lng: 81.613873, lat:7.824718 },
            {lng: 81.691082, lat:7.76139 },
            {lng: 81.704991, lat:7.747636 },
            {lng: 81.713882, lat:7.729163 },
            {lng: 81.712455, lat:7.715881 },
            {lng: 81.687346, lat:7.701536 },
            {lng: 81.686246, lat:7.681672 },
            {lng: 81.707219, lat:7.65049 },
            {lng: 81.719082, lat:7.639454 },
            {lng: 81.731491, lat:7.637799 },
            {lng: 81.753837, lat:7.611863 },
            {lng: 81.772219, lat:7.570281 },
            {lng: 81.76471, lat:7.548336 },
            {lng: 81.756937, lat:7.504027 },
            {lng: 81.766664, lat:7.462781 },
            {lng: 81.794982, lat:7.444718 },
            {lng: 81.810346, lat:7.441927 },
            {lng: 81.818882, lat:7.472918 },
            {lng: 81.828882, lat:7.470972 },
            {lng: 81.855819, lat:7.405281 },
            {lng: 81.871373, lat:7.352499 },
            {lng: 81.871373, lat:7.352499 },
            {lng: 81.878864, lat:7.312218 },
            {lng: 81.881655, lat:7.288054 },
            {lng: 81.879428, lat:7.168054 },
            {lng: 81.891664, lat:7.013609 },
            {lng: 81.890546, lat:7.000554 },
            {lng: 81.881364, lat:6.958054 },
            {lng: 81.849155, lat:6.831663 },
            {lng: 81.849155, lat:6.831663 },
            {lng: 81.806928, lat:6.699445 },
            {lng: 81.792482, lat:6.679163 },
            {lng: 81.785264, lat:6.672499 },
            {lng: 81.784573, lat:6.639863 },
            {lng: 81.78221, lat:6.624718 },
            {lng: 81.777773, lat:6.615272 },
            {lng: 81.763319, lat:6.588054 },
            {lng: 81.709719, lat:6.502218 },
            {lng: 81.69971, lat:6.484445 },
            {lng: 81.677473, lat:6.458054 },
            {lng: 81.6611, lat:6.439999 },
            {lng: 81.611373, lat:6.402499 },
            {lng: 81.4086, lat:6.252499 },
            {lng: 81.324155, lat:6.198327 },
            {lng: 81.314419, lat:6.194445 },
            {lng: 81.055546, lat:6.107772 },
            {lng: 81.019146, lat:6.103054 },
            {lng: 80.991364, lat:6.096663 },
            {lng: 80.890291, lat:6.062018 },
            {lng: 80.829164, lat:6.040836 },
            {lng: 80.792482, lat:6.016109 },
            {lng: 80.77971, lat:6.004718 },
            {lng: 80.745255, lat:5.977218 },
            {lng: 80.700546, lat:5.959445 },
            {lng: 80.589573, lat:5.918054 },
            {lng: 80.453046, lat:5.945272 },
            {lng: 80.286791, lat:5.99139 },
            {lng: 80.243319, lat:6.007499 },
            {lng: 80.200819, lat:6.026109 },
            {lng: 80.184419, lat:6.034718 },
            {lng: 80.1136, lat:6.11639 },
            {lng: 80.082764, lat:6.168054 },
            {lng: 80.0461, lat:6.239718 },
            {lng: 80.021928, lat:6.325281 },
            {lng: 79.986482, lat:6.432363 },
            {lng: 79.9697, lat:6.527781 },
            {lng: 79.951937, lat:6.574999 },
            {lng: 79.9247, lat:6.64389 },
            {lng: 79.898882, lat:6.707218 },
            {lng: 79.88081, lat:6.751109 },
            {lng: 79.859146, lat:6.797363 },
            {lng: 79.851382, lat:6.83639 },
            {lng: 79.837282, lat:6.937572 },
            {lng: 79.848037, lat:6.960281 },
            {lng: 79.862164, lat:6.980072 },
            {lng: 79.861373, lat:6.993054 },
            {lng: 79.852764, lat:7.123054 },
            {lng: 79.830555, lat:7.197218 },
            {lng: 79.835955, lat:7.268309 },
            {lng: 79.833882, lat:7.296663 },
            {lng: 79.816937, lat:7.402772 },
            {lng: 79.814991, lat:7.414445 },
            {lng: 79.789573, lat:7.607499 },
            {lng: 79.795537, lat:7.634445 },
            {lng: 79.796937, lat:7.66139 },
            {lng: 79.783873, lat:7.750554 },
            {lng: 79.753055, lat:7.88389 },
            {lng: 79.743319, lat:7.921945 },
            {lng: 79.739428, lat:7.931663 },
            {lng: 79.732482, lat:7.945554 },
            {lng: 79.726655, lat:7.960281 },
            {lng: 79.718046, lat:7.985836 },
            {lng: 79.71471, lat:7.99639 },
            {lng: 79.7122, lat:8.007499 },
            {lng: 79.708987, lat:8.023119 },
            {lng: 79.707968, lat:8.028071 },
            {lng: 79.706373, lat:8.035827 },
            {lng: 79.705204, lat:8.048929 },
            {lng: 79.702482, lat:8.079445 },
            {lng: 79.6979, lat:8.194445 },
            {lng: 79.7086, lat:8.220827 },
            {lng: 79.715729, lat:8.231178 },
            {lng: 79.722764, lat:8.24139 },
            {lng: 79.74854, lat:8.265 },
            {lng: 79.749145, lat:8.265554 },
            {lng: 79.725118, lat:8.125554 },
            {lng: 79.728283, lat:8.046392 },
            {lng: 79.729428, lat:8.017772 },
            {lng: 79.732482, lat:8.007081 },
            {lng: 79.747837, lat:7.991181 },
            {lng: 79.762773, lat:7.984999 },
            {lng: 79.786928, lat:7.981109 },
            {lng: 79.80081, lat:7.980827 },
            {lng: 79.814564, lat:7.984445 },
            {lng: 79.824582, lat:7.991809 },
            {lng: 79.829991, lat:8.000272 },
            {lng: 79.830273, lat:8.012781 },
            {lng: 79.8261, lat:8.022499 },
            {lng: 79.814419, lat:8.039445 },
            {lng: 79.813037, lat:8.245827 },
            {lng: 79.827609, lat:8.322688 },
            {lng: 79.8681, lat:8.536245 },
            {lng: 79.894316, lat:8.552663 },
            {lng: 79.895827, lat:8.553609 },
            {lng: 79.914672, lat:8.562209 },
            {lng: 79.914673, lat:8.562209 },
            {lng: 79.941928, lat:8.630827 },
            {lng: 79.94468, lat:8.662565 },
            {lng: 79.95, lat:8.723891 },
            {lng: 79.94982, lat:8.731996 },
            {lng: 79.94971, lat:8.736945 },
            {lng: 79.942324, lat:8.775111 },
            {lng: 79.929982, lat:8.838891 },
            {lng: 79.919082, lat:8.937636 },
            {lng: 79.973036, lat:8.971945 },
            {lng: 79.991363, lat:8.981109 },
            {lng: 80.041372, lat:9.014445 },
            {lng: 80.041826, lat:9.015055 },
            {lng: 80.050264, lat:9.02639 },
            {lng: 80.064419, lat:9.06139 },
            {lng: 80.10721, lat:9.179999 },
            {lng: 80.111646, lat:9.198609 },
            {lng: 80.123028, lat:9.251109 },
            {lng: 80.116655, lat:9.297918 },
            {lng: 80.107755, lat:9.306109 },
            {lng: 80.098037, lat:9.310554 },
            {lng: 80.094437, lat:9.41139 },
            {lng: 80.135819, lat:9.425272 },
            {lng: 80.194973, lat:9.470272 },
            {lng: 80.194972, lat:9.470273 },
            {lng: 80.189522, lat:9.482059 },
            {lng: 80.186237, lat:9.489163 },
            {lng: 80.186236, lat:9.489164 },
            {lng: 80.176654, lat:9.500273 },
            {lng: 80.169913, lat:9.506747 },
            {lng: 80.155255, lat:9.520827 },
            {lng: 80.143882, lat:9.528676 },
            {lng: 80.134718, lat:9.535 },
            {lng: 80.127475, lat:9.538762 },
            {lng: 80.120819, lat:9.542218 },
            {lng: 80.08611, lat:9.563609 },
            {lng: 80.06407, lat:9.57812 },
            {lng: 80.056782, lat:9.582918 },
            {lng: 80.051092, lat:9.592499 },
            {lng: 80.06581, lat:9.594163 },
            {lng: 80.083054, lat:9.590918 },
            {lng: 80.089427, lat:9.589718},
            {lng: 80.238036, lat:9.530836 },
            {lng: 80.276654, lat:9.499718},
            {lng: 80.321827, lat:9.497219 },
            {lng: 80.472491, lat:9.488881 },
            {lng: 80.493319, lat:9.481663 },
            {lng: 80.523037, lat:9.469163 },
            {lng: 80.537764, lat:9.462772 },
            {lng: 80.549428, lat:9.452772 },
            {lng: 80.552586, lat:9.450562 },
            {lng: 80.557754, lat:9.446945 },
            {lng: 80.569445, lat:9.444718 },
            {lng: 80.610327, lat:9.444718 },
            {lng: 80.610328, lat:9.444718 },
            {lng: 80.603917, lat:9.449783 },
            {lng: 80.588882, lat:9.461664 },
            {lng: 80.553952, lat:9.482206 },
            {lng: 80.536928, lat:9.492218 },
            {lng: 80.498912, lat:9.512824 },
            {lng: 80.464154, lat:9.531664 },
            {lng: 80.4289, lat:9.537473 },
            {lng: 80.407327, lat:9.532891 },
            {lng: 80.384354, lat:9.5316 },
            {lng: 80.331663, lat:9.555273 },
            {lng: 80.3147, lat:9.572773 },
            {lng: 80.298872, lat:9.585 },
            {lng: 80.210263, lat:9.636391 },
            {lng: 80.202118, lat:9.640621 },
            {lng: 80.196364, lat:9.643609 },
            {lng: 80.191501, lat:9.645502 },
            {lng: 80.183872, lat:9.648473 },
            {lng: 80.171143, lat:9.644208 },
            {lng: 80.169355, lat:9.643609 },
            {lng: 80.169354, lat:9.643609 },
            {lng: 80.168045, lat:9.631664 },
            {lng: 80.168046, lat:9.631664 },
            {lng: 80.168046, lat:9.631663 },
            {lng: 80.170332, lat:9.628589 },
            {lng: 80.176927, lat:9.619718 },
            {lng: 80.185432, lat:9.615082 },
            {lng: 80.1861, lat:9.614718 },
            {lng: 80.197482, lat:9.602081 },
            {lng: 80.195882, lat:9.586873 },
            {lng: 80.188142, lat:9.583648 },
            {lng: 80.18471, lat:9.582218 },
            {lng: 80.157261, lat:9.589823 },
            {lng: 80.120527, lat:9.6 },
            {lng: 80.032397, lat:9.641127 },
            {lng: 80.0247, lat:9.644718 },
            {lng: 79.945691, lat:9.690445 },
            {lng: 79.942832, lat:9.695952 },
            {lng: 79.939146, lat:9.703054 },
            {lng: 79.92581, lat:9.744718 },
            {lng: 79.92581, lat:9.770827 },
            {lng: 79.969982, lat:9.809999 },
            {lng: 79.980954, lat:9.816527 },
            {lng: 79.990254, lat:9.817147 },
            {lng: 80.016391, lat:9.81889 },
            {lng: 80.027124, lat:9.818673 },
            {lng: 80.030272, lat:9.818609 },
            {lng: 80.056049, lat:9.813783 },
            {lng: 80.113645, lat:9.802999 },
            {lng: 80.124827, lat:9.778127 },
            {lng: 80.136027, lat:9.769054 },
            {lng: 80.145449, lat:9.768713 },
            {lng: 80.162664, lat:9.76809 },
            {lng: 80.179987, lat:9.758831 },
            {lng: 80.196254, lat:9.750136 },
            {lng: 80.205045, lat:9.750502 },
            {lng: 80.226382, lat:9.75139 },
            {lng: 80.233319, lat:9.744163 },
            {lng: 80.249737, lat:9.71249 },
            {lng: 80.274428, lat:9.694999 },
            {lng: 80.280528, lat:9.687283 },
            {lng: 80.309563, lat:9.650554 },
            {lng: 80.351927, lat:9.619718 },
            {lng: 80.364427, lat:9.611109 },
            {lng: 80.391654, lat:9.593054 },
            {lng: 80.441918, lat:9.577009 },
            {lng: 80.441917, lat:9.57701 },
            {lng: 80.441919, lat:9.577009 },
            {lng: 80.343539, lat:9.660172 },
            {lng: 80.272763, lat:9.72 },
            {lng: 80.257722, lat:9.736816 },
            {lng: 80.224055, lat:9.774454 },
            {lng: 80.202482, lat:9.769718 },
            {lng: 80.189146, lat:9.770554 },
            {lng: 80.178032, lat:9.774578 },
            {lng: 80.1554, lat:9.782773 },
            {lng: 80.145251, lat:9.789226 },
            {lng: 80.140546, lat:9.792218 },
            {lng: 80.142172, lat:9.793828 },
            {lng: 80.161282, lat:9.812736 },
            {lng: 80.186693, lat:9.817598 },
            {lng: 80.242064, lat:9.82819 },
    ];
    ...
    //     var SLLatLonForFunction = new google.maps.Polygon({paths: SLOuterBorder});
      ...
      var SLOuterBorderOnMap = new google.maps.Polygon({
            paths: [SLOuterBorder, slLandBorder ],
            strokeColor: '#FF0000',
            strokeOpacity: 0.7,
            strokeWeight: 1.6,
            fillColor: '#BFEFFF',
        ...
        var SLBorderYouCreatedOnMap = new google.maps.Polygon({
            paths: [SLborderYouCreatedLatLng,slLandBorder ],
           // paths: [SLborderYouCreatedLatLng],
            strokeColor: '#2626FF',    // inner border color
            strokeOpacity: 0.7,
            strokeWeight: 1.7,
            fillColor: '#4D4DFF',  //  inner fill color
            fillOpacity: 0.35
        });
...
/*================ this function will repeat the notificatioFunction function and this is the ajax call=============*/
        ...
        var myVar = setInterval(function(){ myFunction() }, 4500);
                      ...
                      $.ajax({
                          ...
                          success: function (tableNamesResponse) {
                              ...
                              for (i = 0; i < tableNamesResponse.length ; i++) {  // this for loop help to call notificatioFunction() functon
                                  ...
                                  // alert(i);
                                  (function(x){  /*  this function was very usefull to work the for loop correctly   */
                                  ...
                                  $.ajax({
                                      ...
                                      success: function (BoatLatLogResponse) {
                                          ...
                                          if (markersAry.length == 0) {
                                              ...
                                              notificatioFunction(boatLatLongASInputsShow, BoatLatLogResponse, map, tableNamesResponse[x]);
                                          }
                                          /* else if (markersAry.length == 1) {
                                           ...
                                           notificatioFunction(boatLatLongASInputsShow, BoatLatLogResponse, map);
                                              ...
                                              for (var t = 0; t < markersAry.length - (tableNamesResponse.length - 1); t++) {
                                                  ...
                                                  //   markersAry = [];  // if you not do this array will increse, but unable to do this.
                                              }
