...
class data_retrive_tmptable
{
    ...
    function get_data(){
        $connection = mysqli_connect($this->host, $this->user,$this->pass,$this->db );
         ...
         //  SELECT table_name, table_type FROM information_schema.tables WHERE table_schema = 'boatlocator' ORDER BY table_name
...
$ResponseTableName = $hello->get_data($postingDataPhp);
echo $ResponseTableName;
