...
<script>
    ...
    /*============================function for hide Notificatio Function=======================================*/

    function hideNotificatioFunction( boatLatLongASInput ,google_path , map  ) {
        ...
        if (google.maps.geometry.poly.containsLocation(boatLatLongASInput, SLLatLonForFunction) == true) {
            ...
            if (google.maps.geometry.poly.containsLocation(boatLatLongASInput, LatLonForFunctionYuCreated) == true) {
                ...
                for (var i = 1; i < google_path.length; i++) {

                    var marker = new google.maps.Marker({
                        position: google_path[1],
                        map: map,
                        icon: {
                            path: google.maps.SymbolPath.CIRCLE,
                            fillColor: "#00B4DFFF",   // #0040FF   #B4DFFF(wont clor)
                            fillOpacity: 1,
                            strokeColor: '#00B4DFFF',
                            strokeWeight: .5,
                            scale: 6
                        }
                    });
                ...
                for (var i = 1; i < google_path.length; i++) {
                    ...
                    var marker = new google.maps.Marker({
                        ...
                        icon: {
                            path: google.maps.SymbolPath.CIRCLE,
                            fillColor: "#B4DFFF",   // #0040FF   #B4DFFF(wont clor)
                            fillOpacity: 1,
                            strokeColor: '#B4DFFF',
                            strokeWeight: .5,
                            scale: 6
            ...
            for (var i = 1; i < google_path.length; i++) {
                ...
                var marker = new google.maps.Marker({
                    ...
                    icon: {
                        path: google.maps.SymbolPath.CIRCLE,
                        fillColor: "#A3CCFF",  // #0040FF   #A3CCFF(wont clor)
                        fillOpacity: 1,
                        strokeColor: '#A3CCFF',
                        strokeWeight: .5,
                        scale: 6
    ...
    /*=========================================end of hideNotificatio Function============================*/
    ...
    function initMap() {
        ...
        /*
         var google_path1 = JSON.parse('<?php // echo $data1; ?>');
         var boatLatLongASInputs1 = new google.maps.LatLng (google_path1[0]);

         var google_path2 = JSON.parse('<?php// echo $data2; ?>');
         var boatLatLongASInputs2 = new google.maps.LatLng (google_path2[0]);

         var google_path3 = JSON.parse('<?php// echo $data3; ?>');
         var boatLatLongASInputs3 = new google.maps.LatLng (google_path3[0]);

         var google_pathAry = [];
         google_pathAry[0] = google_path1;
         google_pathAry[1] = google_path2;
         google_pathAry[2] = google_path3;

         alert( google_pathAry[0]);

         var boatLatLongASInputsAry = [];
         boatLatLongASInputsAry[0] = boatLatLongASInputs1;
         boatLatLongASInputsAry[1] = boatLatLongASInputs2;
         boatLatLongASInputsAry[2] = boatLatLongASInputs3;

         alert(boatLatLongASInputsAry[0]);

         var t;
         for (t = 0; t < 3; t++) {
         //    notificatioFunction(boatLatLongASInputsAry[t], google_pathAry[t], map);
         }
         /* notificatioFunction( boatLatLongASInputs1 , google_path1 , map );
         notificatioFunction( boatLatLongASInputs2 , google_path2 , map );
         notificatioFunction( boatLatLongASInputs3 , google_path3 , map );*/
...
/*================ this function will repeat the notificatioFunction function and this is the ajax call=============*/
        ...
        var myVar = setInterval(function(){ myFunction() }, 25000);
              ...
              function myFunction() {
                  ...
                  $(document).ready(function () {
                      ...
                      $.ajax({
                          ...
                          dataType: 'JSON',
                          data: {postingData: tableName},

                          success: function (response) {
                              //alert(response);

                           //   var google_path1 = JSON.parse(response[0]);
                           //   var google_path2 = JSON.parse(response[1]);
                              var boatLatLongASInputsShow = new google.maps.LatLng(response[0]);
                              var boatLatLongASInputsHiding = new google.maps.LatLng(response[1]);

                              alert("real:-" + boatLatLongASInputsShow);
                              alert("hiding:-" + boatLatLongASInputsHiding);


                              clearMarkers();
                              notificatioFunction(boatLatLongASInputsShow, response, map);
                              showMarkers();

                             // hideNotificatioFunction(boatLatLongASInputsHiding,response, map);
