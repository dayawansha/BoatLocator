...
<script>
    ...
    function initMap() {
        ...
        var myVar = setInterval(function(){ myFunction() }, 10000);
              ...
              function myFunction() {
                  ...
                  $(document).ready(function () {
                      ...
                      $.ajax({
                          ...
                          data: {udataD: postdataD},

                          success: function (response) {
                              //alert(response);

                              var boatLatLongASInputs1 = new google.maps.LatLng(response[0]);
                              alert(boatLatLongASInputs1);

                              notificatioFunction(boatLatLongASInputs1, response, map);
                          },
                          error: function () {
                              alert('failure');
                          }
